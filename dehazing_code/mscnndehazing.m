...
%     end
   figure;imshow(img0);title('hazy image');
   figure;imshow(map1);title('Transmission of Coarselayer');
   figure;imshow(map2);title('Transmission of Finelayer');
   figure;imshow(dehazedImageRGB);title('dehazed image');
% end
